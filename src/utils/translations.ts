...
export const translations = {
  hu: {
    ...
    portfolio: {
      ...
      projects: {
        ...
        villa: "Napfényes Villa",
        olive: "Olívaág Otthon",
        seaside: "Tengerparti Apartman",
        coastal: "Parti Lakás",
        azure: "Azúr Ház",
        terrace: "Teraszos Otthon",
        garden: "Kerti Villa"
      },
      descriptions: {
    ...
    about: {
      ...
      reasons: {
        ...
        craftsmanship: "Egyedi, kézműves megoldások",
        service: "Teljes körű ügyintézés"
      }
    },
    // Contact
    contact: {
      ...
      form: {
        ...
        email: "E-mail",
        phone: "Telefonszám",
        service: "Szolgáltatás iránti érdeklődés",
        message: "Üzenet",
        submit: "Küldés",
        serviceOptions: {
      ...
      details: {
        ...
        email: "E-mail: info@pelda.hu",
        office: "Iroda: Budapest, Váci utca 50, 1134"
      },
  ...
  en: {
    ...
    // Hero Section
    hero: {
      headline: "Bringing Mediterranean Interiors to Life",
      subheading: "Elegant, Airy Spaces—Now in Hungary",
    ...
    portfolio: {
      ...
      projects: {
        ...
        villa: "Sunlit Villa",
        olive: "Olive Branch Home",
        seaside: "Seaside Apartment",
        coastal: "Coastal Residence",
        azure: "Azure House",
        terrace: "Terrace Home",
        garden: "Garden Villa"
      },
      descriptions: {
    ...
    about: {
      ...
      reasons: {
        ...
        craftsmanship: "Unique, Handcrafted Solutions",
        service: "Complete Turnkey Service"
      }
    },
    // Contact
    contact: {
      ...
      details: {
        ...
        office: "Office: Váci Street 50, Budapest 1134"
      },
